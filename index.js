...
contributionsCard.innerHTML = `
    ${totalCont.toLocaleString('en-US')}
`;
...
function filterUnfundedOnly() {
    ...
    const filteredList = GAMES_JSON.filter((game) => {
...
const unfundedText = unfunded.length > 1? `Currently, ${unfunded.length} games remain unfunded. We need your help to fund these games!`
                                        :`Currently, ${unfunded.length} game remains unfunded. We need your help to fund these games!`;


// create a new DOM element containing the template string and append it to the description container
const unfundedElement = document.createElement("p");
unfundedElement.innerHTML = unfundedText;
...
topGameElement.innerHTML = first.name;

firstGameContainer.appendChild(topGameElement);

// do the same for the runner up item
const runnerUpGameElement = document.createElement("p");
runnerUpGameElement.innerHTML = second.name;
